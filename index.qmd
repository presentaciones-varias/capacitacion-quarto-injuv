...
- El objetivo de quarto es mejorar el proceso de creación y colaboración en documentos científicos y técnicos.
  ...
  - Para ello, quarto combina en un único sistema consistente la funcionalidad de R Markdown, bookdown, distill, xaringan, etc.
...
[<img src="images/logo_quarto_rmarkdown.png" width="30%"/>]{.center}
...
- R Markdown está fundamentalmente atado a R. 
...
knitr::knit_hooks$set(size = function(before, options, envir) {   # <2>
  if (before) {
    paste0("\\", options$size)
  } else {
    "\\tiny"}
...
2. Modificación del tamaño de letra para los chunks de código, las opciones son "normalsize", small", "tiny", "huge", entre otras.
</div>
...
## Elementos base | Bloques de código: R (1/3)
...
## Elementos base | Bloques de código: R (2/3)
...
## Elementos base | Bloques de código: R (3/3)
...
¡Apliquemos los formatos en RStudio! 

. . .

:::{.medium-par .incremental}

- Descargue los archivos disponibles en la carpeta *ejemplos_presentacion* y veamos los estilos aplicados
